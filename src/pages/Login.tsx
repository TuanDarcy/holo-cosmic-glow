    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading font-bold text-3xl text-foreground mt-4 text-glow-cyan">Welcome Back</h1>
          <p className="text-muted-foreground text-sm mt-2">Sign in to your HoloShop account</p>
        </div>
        ...
        <div className="glass-panel iridescent-border rounded-2xl p-8" style={{ backdropFilter: "blur(20px)" }}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              className="glass-panel iridescent-border flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium text-foreground hover:bg-muted/30 transition-all"
              onClick={() => toast({ title: "Coming Soon", description: "Discord login will be available soon" })}
            >
